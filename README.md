...
### 5. 홈 화면 위젯
- iOS 및 Android 홈 화면 위젯 지원
- 목표 이름 및 남은 시간 실시간 표시
- 목표 상태에 따라 자동 업데이트
- 앱을 열지 않고도 목표 확인 가능
...
│   └── widget_service.dart            # 홈 화면 위젯 관리 서비스
├── widgets/
...
- iOS 및 Android 홈 화면 위젯 지원
- 목표 정보를 위젯에 실시간 표시
- 목표 생성/완료/삭제 시 자동 업데이트
- App Group을 통한 앱-위젯 간 데이터 공유 (iOS)
